    ...
    <div class="slimscroll-menu" id="remove-scroll">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu" id="side-menu">
                ...
                <li>
                    <a href="javascript:void(0);" class="waves-effect"><i class="ion ion-md-mail"></i><span> Correo <span class="float-right menu-arrow"><i class="mdi mdi-chevron-right"></i></span> </span></a>
                    <ul class="submenu">
                        <li><a href="email-inbox.php">Inbox</a></li>
                        <li><a href="email-contestados.php">Contestados</a></li>
                    </ul>
                </li>
