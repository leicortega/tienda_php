...
(function (global, factory) {
  ...
  var editor = renderer.create('<div class="note-editor note-frame card" id="noteditor"/>');
  var toolbar = renderer.create('<div class="note-toolbar card-header" role="toolbar"></div>');
  var editingArea = renderer.create('<div class="note-editing-area"/>');
  var codable = renderer.create('<textarea class="note-codable" role="textbox" aria-multiline="true"/>');
  var editable = renderer.create('<div class="note-editable card-block" id="respuesta" contentEditable="true" role="textbox" aria-multiline="true"/>');
